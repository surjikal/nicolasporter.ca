        ...
        terms: [
          {
            ...
            tasks: ["Built hybrid mobile web app using AngularJS and Cordova/PhoneGap", "Built analytics dashboard (AngularJS), featuring a cache-manifest-based offline mode (for demo purposes)", "Finalist at the first Fashion Hackathon in NYC (team 42)"],
        ...
        terms: [
          {
            ...
            tasks: ["Node.js development on a multi-tenant web app (BlazeLoop)", "Designed and implemented rule-based, dynamic API system, significantly improving mantainability and extensibility of app", "Installed metrics stack (StatsD & Graphite), integrated it with app"],
            ...
            tasks: ["Designed and built prototype for the BlazeLoop web app using Django and Sencha Touch"],
            ...
            tasks: ["Python and Django development on web app for one of the largest restaurant chains in the US"],
