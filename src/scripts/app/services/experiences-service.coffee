...
app.service 'experiences', -> [
  ...
  terms: [
    ...
    tasks: [
      ...
      "Built an analytics dashboard (AngularJS), featuring a cache-manifest-based offline mode."
      "Finalist at the first Fashion Hackathon in NYC, presented the product on the runway during Fashion Week NYC."
    ]
    technologies: [
...
,
  ...
  terms: [
    ...
    tasks: [
      ...
      "Designed and implemented a dynamic API system, significantly improving maintainability of BlazeLoop"
  ...
  ,
    duration:
      ...
      stop:  'September 2011'
    tasks: [
      "Designed and built prototype for a new mobile web app, BlazeLoop"
      "Fixed BlazeCast's (Benbria's main product)"
    ]
    technologies: [
  ...
  ,
    duration:
      ...
      stop:  'September 2010'
    tasks: [
      "Built and shipped a Django-based web app for one of the largest restaurant chains in the US"
    ]
    technologies: [
